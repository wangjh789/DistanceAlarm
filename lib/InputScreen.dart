...
class InputScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    TextEditingController standardDistanceInput = TextEditingController();
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Flexible(
                  child: TextField(
                    controller: standardDistanceInput,
                    keyboardType: TextInputType.datetime,
                  ),
                ),
              ],
                ...
                onPressed: () {
                  ...
                  if (parseToIpAddr().length > 20) {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => ShowDistanceScreen(
                            parseToIpAddr(),
                            int.parse(
                                standardDistanceInput.value.text.trim()))));
                  }
                },
                child: Text("Connect"))
          ],
